...
from serializers import UserLogin,RestUserLoginResponse,UserUpdate,BaseRestResponse
...
async def get_all_users(db:AsyncSession=Depends(get_db)):
    ...
    Returns:
        Any: The result of the ControllerGetAllUsers function, which handles the retrieval logic.
    """
...
async def create_user(user:CreateUser,db:AsyncSession=Depends(get_db)):
    ...
    Args:
        ...
        db (AsyncSession, optional): The asynchronous database session, injected by dependency.
    Returns:
        Any: The result of the user creation process, as returned by ControllerCreateUser.
    """
...
async def delete_user(user_id:str,current_user: UserModel = Depends(get_current_user),db:AsyncSession=Depends(get_db)):
    ...
    Args:
        ...
        db (AsyncSession, optional): The asynchronous database session, injected via dependency.
    Returns:
        Any: The result of the user deletion operation, as handled by ControllerUpdateUser.
    """
