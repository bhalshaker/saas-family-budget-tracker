...
from serializers import RestCreateAccountResponse, RestGetAccountResponse, RestGetAllAccountsOfamilyResponse, BaseRestResponse
...
async def update_account(account_id: str,updated_account:CreateAccount,current_user: UserModel, db: AsyncSession)->RestCreateAccountResponse:
    pass
